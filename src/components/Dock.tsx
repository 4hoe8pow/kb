		...
		<AnimatePresence>
			{isVisible && (
				<motion.div
					...
					className={`${className} absolute -top-6 left-1/2 w-fit whitespace-pre rounded-md border border-safari/70 bg-chocolate-martini px-2 py-0.5 text-xs text-cannoli-cream`}
					role="tooltip"
					style={{ x: "-50%" }}
				>
					{children}
